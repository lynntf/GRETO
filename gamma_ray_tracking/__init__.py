...
R_0 = physical_constants['classical electron radius'][0]*100 # Classical electron Radius [cm]
MEC2 = physical_constants['electron mass energy equivalent in MeV'][0] # electron mass [MeV]
ALPHA = physical_constants['fine-structure constant'][0] # fine structure constant 1/137
